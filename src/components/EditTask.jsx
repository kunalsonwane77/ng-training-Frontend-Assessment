...
function EditTask() {
  ...
  return (
    ...
    <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 p-4 border-2 rounded-md'> 
       <label>Assign to
         <select name="User" id="" value={edit.User} onChange={editchange} >
       ...
       <label> 
          ...
          <select name="Status" id="" value={edit.Status} onChange={editchange}>
   ...
   <label >
      Due Date
        <input type="date" name="Date" id="" value={edit.Date} onChange={editchange} />
   </label>


   <label > 
    Priority
    <select name="Priority" id="" value={edit.Priority} onChange={editchange}>
      <option value="" disabled>select</option>
...
<input type="text" name="Comment" id="" className='w-[100%] h-[100px] border-2' value={edit.Comment} onChange={editchange} />
   ...
   <button className='border-2 my-3 p-4 w-full sm:w-auto' onClick={()=>{
